...
\draw[arrow] (redis.south) |- (api.west);
\draw[arrow] (pgop.south) |- (api.east);
...
\begin{tikzpicture}[
    node distance=0.2cm,
    font=\small,
    step/.style={draw=black!60, rounded corners=3pt, fill=softgray, text width=11.9cm, align=left, inner sep=6pt},
